...
export const valentineDays: ValentineDay[]= [
  {
    ...
    date: '2026-02-07',
    accentColor: '#ff5c8a',
    importance: 'A day to express love through a simple rose.',
    cardBgImage:
...
तेरे सिवाए मुझपर किसी का हक नहीं`,
  ...
  },
  {
    ...
    date: '2026-02-08',
    accentColor: '#ff8fab',
    importance: 'A day to confess feelings straight from the heart.',
    cardBgImage:
...
यूं खुद को मेरा हमनाम कर दो।`,
  ...
  },
  {
   ...
   accentColor: '#d08a3c',
    ...
    importance: 'To share sweetness and small joys together.',
    cardBgImage:
  ...
  },
  {
    ...
    date: '2026-02-10',
    accentColor: '#ffb703',
    importance: 'A reminder of comfort, warmth, and cuddles.',
    cardBgImage:
  ...
  },
  {
    ...
    date: '2026-02-11',
    accentColor: '#9b5de5',
    importance: 'A day to commit to love, trust, and togetherness.',
    cardBgImage:
...
कयामत तक साथ निभाएंगे, ये वादा है आपसे।`,
  ...
  },
  {
    ...
    date: '2026-02-12',
    accentColor: '#ff9f9f',
    importance: 'Because sometimes a hug says everything.',
    cardBgImage:
      'https://c.ndtvimg.com/2023-02/75eq3tvo_hug-day_295x200_12_February_23.jpg',
    bgImage:
      'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=1920&q=80',
    line: 'Some hugs say more than a thousand words.',
    shayari:
      'Ek hug mein sab kuch keh doon,\nTeri baahon mein hi sukoon pa loon.',
  },
  {
    slug: 'kiss-day',
    title: 'Kiss Day 💋',
    date: '2026-02-13',
    accentColor: '#ff006e',
    importance: 'A moment where emotions speak silently.',
    cardBgImage:
      'https://kalingatv.com/wp-content/uploads/2025/02/kiss-day.jpeg',
    bgImage:
      'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1920&q=80',
    line: 'One kiss, infinite emotions.',
    shayari: 'Ek kiss mein bandhi mohabbat,\nDil se dil tak ki chahat.',
  },
  {
    slug: 'valentines-day',
    ...
    date: '2026-02-14',
    accentColor: '#ff1744',
    importance: 'A celebration of love, today and forever.',
    cardBgImage:
      'https://media.istockphoto.com/id/466356565/vector/happy-valentines-day-red-heart-paper-sticker.jpg?s=612x612&w=0&k=20&c=uAs0nIf_JZzQzOTeUTUh3iu8ei7rSWdkBgaS8MDKdi8=',
    bgImage:
      'https://images.unsplash.com/photo-1495567720989-cebdbdd97913?auto=format&fit=crop&w=1920&q=80',
    line: 'You are my forever.',
    shayari: 'Na sirf Valentine’s Day,\nTu meri zindagi ka har day.',
  },
];
